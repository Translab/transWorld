...
public class NewGen_6 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        */
        ...
        for (int j = 0; j < 100; j++)
        {
            for (int i = 0; i < 10; i++)
            {
                CreateCylinderBetweenPoints(new Vector3(numbers[i + j] * (2 - (j / 100f)) * -1, numbers[i + j + 1] * (2 - (j / 100f)) * -1, numbers[i + j + 2] * (2 - (j / 100f)) * -1),
                                            new Vector3(numbers[i + j + 1] * (2 - (j / 100f)) * -1, numbers[i + j + 2] * (2 - (j / 100f)) * -1, numbers[i + j + 3] * (2 - (j / 100f)) * -1),
                                            100.0f, i, j);
    ...
    {
        GameObject group = GameObject.Find("ObjectGen_6");
