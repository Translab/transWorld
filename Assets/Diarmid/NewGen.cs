...
public class NewGen_2 : MonoBehaviour
{
    ...
    {
        GameObject group = GameObject.Find("ObjectGen_2");
        ...
        //cylinder.transform.localScale = new Vector3(((j / 100f * (j / 100f) + 0.01f) * width), offset.magnitude / ((j / 100f * (j / 100f) * 80f) + 1), ((j / 100f * (j / 100f) + 0.01f) * width));
